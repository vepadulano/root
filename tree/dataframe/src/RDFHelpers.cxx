...
ROOT::RDF::Experimental::VariationsFor(ROOT::RDF::Experimental::SnapshotPtr_t)
{
   throw std::logic_error(
      "The MakeNew method is not implemented for this action helper (Snapshot). Cannot Vary its result.");
}