...
class R__CLING_PTRCHECK(off) RDefine final : public RDefineBase {
   ...
   void UpdateHelper(unsigned int slot, std::size_t idx, Long64_t /*entry*/, TypeList<ColTypes...>, std::index_sequence<S...>, NoneTag)
   {
   ...
   template <typename... ColTypes, std::size_t... S>
   void UpdateHelper(unsigned int slot, std::size_t idx, Long64_t /*entry*/, TypeList<ColTypes...>, std::index_sequence<S...>, SlotTag)
   {
      fLastResults[slot * RDFInternal::CacheLineStep<ret_type>()] =
   ...
   template <typename... ColTypes, std::size_t... S>
   void
   UpdateHelper(unsigned int slot, std::size_t idx, Long64_t batchFirstEntry, TypeList<ColTypes...>, std::index_sequence<S...>, SlotAndEntryTag)
   {
      fLastResults[slot * RDFInternal::CacheLineStep<ret_type>()] =
